...
from .shared_config import stree_shared_cfg

#------------------------ Stree S2V 14B ------------------------#

s2v_14B = EasyDict(__name__='Config: Stree S2V 14B')
s2v_14B.update(stree_shared_cfg)
...
# vae
s2v_14B.vae_checkpoint = 'Stree2.1_VAE.pth'
...
s2v_14B.transformer = EasyDict(
    __name__="Config: Transformer config for StreeModel_S2V")
