...
default_text = "s1:(laughs), s2:(clears throat), s1:(sighs), s2:(gasps), s1:(coughs), s2:(singing), s1:(sings), s2:(mumbles), s1:(beep), s2:(groans), s1:(sniffs), s2:(claps), s1:(screams), s2:(inhales), s1:(exhales), s2:(applause), s1:(burps), s2:(humming), s1:(sneezes), s2:(chuckle), s1:(whistles)"
...
with gr.Blocks(css=css) as demo:
    gr.Markdown("# Author:- Prarabdha Soni:- Text-to-Expression Synthesis")
