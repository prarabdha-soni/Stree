...
from ..model import StreeAttentionBlock, StreeCrossAttention
...
class AudioCrossAttention(StreeCrossAttention):

    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)


class AudioInjector_Stree(nn.Module):
    ...
    def __init__(self,
        ...
        for mod_name, mod in zip(all_modules_names, all_modules):
            if isinstance(mod, StreeAttentionBlock):
