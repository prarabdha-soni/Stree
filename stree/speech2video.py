...
from .modules.s2v.model_s2v import StreeModel_S2V, sp_attn_forward_s2v
from .modules.t5 import T5EncoderModel
from .modules.vae2_1 import Stree2_1_VAE
from .modules.vae2_2 import Stree2_2_VAE
...
class StreeS2V:
    ...
    def __init__(
        ...
        self.vae = Stree2_2_VAE(
            vae_pth=os.path.join(checkpoint_dir, config.vae_checkpoint),
            device=self.device)

        logging.info(f"Creating StreeModel from {checkpoint_dir}")
        if not dit_fsdp:
            self.noise_model = StreeModel_S2V.from_pretrained(
                checkpoint_dir,
